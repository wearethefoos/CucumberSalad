...
public class StepDefinitions {
    ...
    public void i_have_water_bottles(int bottles) {
        fridge = new Fridge(bottles);
    }
    @Given("I have drunk {int} water bottles")
    public void i_have_drunk_water_bottles(int bottles) {
        fridge.Take(bottles);
    }
    ...
    public void i_should_have_water_bottles(int bottles) {
        Assert.assertEquals(bottles , remainingBottles);
    }
}
